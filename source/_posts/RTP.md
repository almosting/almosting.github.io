...
等等，想了解更多可以点击这里：[http://en.wikipedia.org/wiki/RTP_audio_video_profile](http://en.wikipedia.org/wiki/RTP_audio_video_profile)
...
接收报告计数器（RC）：5比特，该SR包中的接收报告块的数目，可以为零。 包类型（PT）：8比特，SR包是200。
